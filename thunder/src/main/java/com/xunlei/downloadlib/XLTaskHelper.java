...
public class XLTaskHelper {
     ...
     * @return
     */
    public synchronized long addThunderTask(String url, String savePath, String fileName) throws DownloadException {
        ...
        if (url.startsWith("ftp://") || url.startsWith("http://") || url.startsWith("https://")) {
            ...
            if (r1 != 9000) {
                ...
                stopTask(getTaskId.getTaskId());
                throw new DownloadException("create task failed");
            }
        ...
        if (r1 != 9000) {
            ...
            stopTask(getTaskId.getTaskId());
            throw new DownloadException("start task failed");
        }
